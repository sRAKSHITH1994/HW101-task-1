...
REM
REM Generated by Vivado on Wed Oct 15 19:30:56 +0530 2025
...
echo "xvlog --incr --relax -prj allgates_vlog.prj"
call xvlog  --incr --relax -prj allgates_vlog.prj -log xvlog.log
